...
Usage:
    ...
    await permissions.grant("projects/my-project/*", agent_id="alice@rikai", access="read")

    # Check access
    can_read = await permissions.check("projects/my-project/readme", "alice@rikai", "read")
...
class PermissionManager:
    ...
    - "projects/my-project/*" - Everything under my-project
