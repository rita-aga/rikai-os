...
from rikai.core.config import get_local_path, ensure_local_path, get_settings
...
def umi_sync(
    ...
    from rikai.umi.sync import UmiSync
...
def connector_sync(
    ...
    async def do_sync():
        try:
            async with UmiClient() as umi:
                if name == "files":
                    from rikai.connectors import FilesConnector, FilesConnectorConfig
                    ...
                    from rikai.connectors import GitConnector, GitConnectorConfig
                    ...
                    from rikai.connectors import ChatConnector, ChatConnectorConfig
...
def federation_connect(
    ...
    async def do_connect():
        try:
            from rikai.umi import UmiClient
            from rikai.federation.agent import AgentFederation
...
def federation_permissions(
    ...
    async def do_list():
        try:
            from rikai.umi import UmiClient
            from rikai.federation.permissions import PermissionManager
