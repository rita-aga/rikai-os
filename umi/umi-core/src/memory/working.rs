...
mod tests {
    ...
    fn test_entry_too_large() {
        ...
        assert!(matches!(result, Err(WorkingMemoryError::EntryTooLarge { .. })));
    }
    ...
    fn test_too_many_entries() {
        ...
        assert!(matches!(result, Err(WorkingMemoryError::TooManyEntries { .. })));
    }
...
mod property_tests {
    ...
    enum WorkingMemoryOp {
        Set { key: String, value_len: usize, ttl_ms: u64 },
        Get { key: String },
        Delete { key: String },
        Cleanup,
    }
        ...
        fn generate_operation(&self, rng: &mut DeterministicRng) -> Self::Operation {
            ...
            match op_type {
                0 => {
                    ...
                    WorkingMemoryOp::Set { key, value_len, ttl_ms }
                }
                1 => {
